...
class HamiltonianImproved(AnchoringHeuristic):
    """
    ...
    def solve(self, graph):
        """
        Solve TSP using improved Hamiltonian heuristic.
        ...
        cycle, _ = solver.solve(start=0, local_search=False)
        return cycle
